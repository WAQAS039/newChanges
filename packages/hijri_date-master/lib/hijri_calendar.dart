...
class HijriCalendar {
  ...
  static Map<String, Map<String, Map<int, String>>> _local = {
    ...
    "ur":{
      ...
      'days': urWkNames,
      'short_days': urShortWkNames
    },
    "hi":{
      'long': hiMonthNames,
      'short': hiMonthShortNames,
      'days': hiWkNames,
      'short_days': hiShortWkNames
    },
    "bn":{
      'long': bnMonthNames,
      'short': bnMonthShortNames,
      'days': bnWkNames,
      'short_days': bnShortWkNames
    },
    "fr":{
      'long': frMonthNames,
      'short': frMonthShortNames,
      'days': frWdNames,
      'short_days': frShortWdNames
    },
    "id":{
      'long': idMonthNames,
    ...
    "es":{
      'long': esMonthNames,
      'short': esMonthShortNames,
      'days': esWkNames,
      'short_days': esShortWkNames
    },
    "de":{
      'long': deMonthNames,
      'short': deMonthShortNames,
      'days': deWkNames,
      'short_days': deWkShortNames
    },
    "zh":{
      'long': zhMonthNames,
      'short': zhMonthShortNames,
      'days': zhWdNames,
      'short_days': zhShortWdNames
    }
  };
